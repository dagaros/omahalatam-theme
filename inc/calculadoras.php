...
function jt_calc_config() {
	...
	$es = array(
		...
		'plo4' => array(
			...
			'lede' => 'La variante clásica de Omaha. Calcula la equity real de tu mano contra la de tus rivales, con resultado exacto desde el flop. Gratis y sin registro.',
		...
		'plo5' => array(
			...
			'lede' => 'La única calculadora de PLO5 en español. Cinco cartas en mano y dos obligatorias en la jugada. Resultado exacto desde el flop, gratis y sin registro.',
		...
		'plo6' => array(
			...
			'lede' => 'Seis cartas en mano: la variante donde la intuición falla más y conviene comprobar los números. Resultado exacto desde el flop, gratis y sin registro.',
	...
	$pt = array(
		...
		'plo4' => array(
			'v' => 4, 'slug' => 'omaha-plo4', 'tab' => 'PLO4', 'nombre' => 'Omaha PLO4',
			'h1a' => 'Calculadora de equity de ', 'h1b' => 'Omaha PLO4',
			'lede' => 'A variante clássica de Omaha. Calcule a equity real da sua mão contra a dos adversários, com resultado exato a partir do flop. Grátis e sem cadastro.',
		...
		'plo5' => array(
			'v' => 5, 'slug' => 'omaha-plo5', 'tab' => 'PLO5', 'nombre' => 'Omaha PLO5',
			'h1a' => 'Calculadora de equity de ', 'h1b' => 'Omaha 5 Cartas',
			'lede' => 'A única calculadora de PLO5 em português. Cinco cartas na mão e duas obrigatórias na jogada. Resultado exato a partir do flop, grátis e sem cadastro.',
		...
		'plo6' => array(
			'v' => 6, 'slug' => 'omaha-plo6', 'tab' => 'PLO6', 'nombre' => 'Omaha PLO6',
			'h1a' => 'Calculadora de equity de ', 'h1b' => 'Omaha PLO6',
			'lede' => 'Seis cartas na mão: a variante onde a intuição erra mais e vale a pena conferir os números. Resultado exato a partir do flop, grátis e sem cadastro.',
