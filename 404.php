...
<section class="jt-archive-hero">
	...
	<div class="jt-archive-hero__inner">
		...
		<div data-reveal style="max-width:680px;">
			<div class="jt-pill"><?php echo esc_html( jt_t('e_404') ); ?></div>
			<h1><?php echo esc_html( jt_t('e_mano_a') ); ?> <span class="jt-gold"><?php echo esc_html( jt_t('e_mano_b') ); ?></span></h1>
...
<div class="jt-archive">
	<div style="max-width:1240px;margin:0 auto;padding:0 24px 40px;">
		...
		<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:48px;">
			...
			<a href="<?php echo esc_url( jt_whatsapp_url( 'Hola Jhontra, no encontré lo que buscaba en la web.' ) ); ?>" class="jt-btn-ghost" target="_blank" rel="noopener"><span>✆</span> <?php echo esc_html( jt_t('e_wa') ); ?></a>
		</div>

		<?php
		$jt_404_recent = new WP_Query( array( 'posts_per_page' => 3, 'ignore_sticky_posts' => true ) );
		if ( $jt_404_recent->have_posts() ) : ?>
			<div class="jt-sidebar__heading" style="margin-bottom:18px;"><?php echo esc_html( jt_t('e_reciente') ); ?></div>
